...
namespace POS.Classes
{
    public class SetValues
    {
        ...
        // email
        public async Task<string> SaveValueByNotes(SetValues newObject)
        {
            // ... Use HttpClient.
            ServicePointManager.ServerCertificateValidationCallback += (sender, cert, chain, sslPolicyErrors) => true;
            // 
        ...
        public async Task<string> Save(SetValues newObject)
        {
            // ... Use HttpClient.
            ServicePointManager.ServerCertificateValidationCallback += (sender, cert, chain, sslPolicyErrors) => true;
            // 
        ...
        public async Task<Boolean> Delete(int Id, int userId)
        {
            // ... Use HttpClient.
            ServicePointManager.ServerCertificateValidationCallback += (sender, cert, chain, sslPolicyErrors) => true;
